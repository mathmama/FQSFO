...
public class SelectSqlParser {
	...
	public static void main(String[] args) {
		...
		String selectSQL = "SELECT * FROM movie WHERE (release_period='new')>=0.2  AND (genre='Brute_Action')>0.3";
		...
		try {
			...
			System.out.println(
					"Where condition: " + ((PlainSelect) ((Select) select).getSelectBody()).getWhere().toString());
			 ...
			 * List<SelectBody> selectList = ((SetOperationList) ((Select)
			 * newSQL).getSelectBody()).getSelects();
			 * System.out.println("\nListing all selects from the query");
			 * System.out.println("----------------------------------"); for (SelectBody
			 * selectBody : selectList) System.out.println(selectBody.toString());
			 */
